...
const UploadIcon: FunctionComponent<SVGAttributes<SVGElement>> = ({ ...props }) => {
  return (
    <svg fill="#000000" version="1.1" id="Capa_1" width="800px" height="800px" viewBox="0 0 395.104 395.104" {...props}>
      <g>
        <g>
          <g id="Layer_5_85_">
            <path
